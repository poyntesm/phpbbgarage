...
$convertor = array(
	...
	'schema' => array(
		...
		array(
			...
			array('vehicle_id',		'garage_images.attach_id',		'determine_image_vehicle_id'),
			...
			array('attach_thumb_width',	'garage_images.attach_thumb_location',	'attach_thumb_width'),
			array('attach_thumb_height',	'garage_images.attach_thumb_location',	'attach_thumb_height'),
			...
			array('attach_thumb_filesize',	'garage_images.attach_thumb_location',	'attach_thumb_filesize'),
		),
		array(
