...
*
* @package phpBB3
* @version $Id: viewtopic.php,v 1.501 2007/07/28 16:40:59 acydburn Exp $
...
$sql = $db->sql_build_query('SELECT', array(
	'SELECT'	=> 'u.*, z.friend, z.foe, p.*, g.id as garage_id, g.made_year, makes.make, models.model',
...
//-- mod start : Garage ----------------------------------------------------------------------------------------------------
//-- add
		'VEHICLE'			=> $user_cache[$poster_id]['made_year'] . ' ' . $user_cache[$poster_id]['make'] . ' ' . $user_cache[$poster_id]['model'],
