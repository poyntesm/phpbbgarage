...
CREATE  INDEX [date_created] ON [phpbb_garage_vehicles]([date_created]) ON [PRIMARY]
GO

CREATE  INDEX [date_updated] ON [phpbb_garage_vehicles]([date_updated]) ON [PRIMARY]
GO

CREATE  INDEX [user_id] ON [phpbb_garage_vehicles]([user_id]) ON [PRIMARY]
GO

CREATE  INDEX [views] ON [phpbb_garage_vehicles]([views]) ON [PRIMARY]
GO
...
CREATE  INDEX [insurance] ON [phpbb_garage_business]([insurance]) ON [PRIMARY]
GO

CREATE  INDEX [garage] ON [phpbb_garage_business]([garage]) ON [PRIMARY]
GO

CREATE  INDEX [retail] ON [phpbb_garage_business]([retail]) ON [PRIMARY]
GO

CREATE  INDEX [product] ON [phpbb_garage_business]([product]) ON [PRIMARY]
GO

CREATE  INDEX [dynocentre] ON [phpbb_garage_business]([dynocentre]) ON [PRIMARY]
GO
...
CREATE  INDEX [title] ON [phpbb_garage_categories]([title]) ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_garage_dynoruns_gallery] WITH NOCHECK ADD 
	CONSTRAINT [PK_phpbb_garage_dynoruns_gallery] PRIMARY KEY  CLUSTERED 
	(
		[id]
	)  ON [PRIMARY] 
GO

CREATE  INDEX [vehicle_id] ON [phpbb_garage_dynoruns_gallery]([vehicle_id]) ON [PRIMARY]
GO

CREATE  INDEX [image_id] ON [phpbb_garage_dynoruns_gallery]([image_id]) ON [PRIMARY]
GO
...
CREATE  INDEX [author_id] ON [phpbb_garage_guestbooks]([author_id]) ON [PRIMARY]
GO

CREATE  INDEX [post_date] ON [phpbb_garage_guestbooks]([post_date]) ON [PRIMARY]
GO
...
CREATE  INDEX [user_id] ON [phpbb_garage_modifications]([user_id]) ON [PRIMARY]
GO

CREATE  INDEX [vehicle_id_2] ON [phpbb_garage_modifications]([vehicle_id], [category_id]) ON [PRIMARY]
GO

CREATE  INDEX [category_id] ON [phpbb_garage_modifications]([category_id]) ON [PRIMARY]
GO

CREATE  INDEX [vehicle_id] ON [phpbb_garage_modifications]([vehicle_id]) ON [PRIMARY]
GO

CREATE  INDEX [date_created] ON [phpbb_garage_modifications]([date_created]) ON [PRIMARY]
GO

CREATE  INDEX [date_updated] ON [phpbb_garage_modifications]([date_updated]) ON [PRIMARY]
GO
