...
CREATE TABLE phpbb_garage_vehicles (
	...
	PRIMARY KEY (id),
	KEY date_created (filetime),
	KEY date_updated (post_msg_id),
...
CREATE TABLE phpbb_garage_business (
	...
	PRIMARY KEY (id),
	KEY insurance (group_id),
	KEY garage (group_id),
	KEY retail (group_id),
	KEY product (group_id),
	KEY dynocentre (group_id)
);
...
CREATE TABLE phpbb_garage_guestbooks (
	...
	PRIMARY KEY (id),
	KEY vehicle_id (vehicle_id),
	KEY author_id (vehicle_id),
	KEY post_date (vehicle_id)
);
...
CREATE TABLE phpbb_garage_modifications (
	...
	KEY category_id (make_id),
	KEY vehicle_id (make_id),
	KEY date_created (make_id),
	KEY date_updated (make_id)
);
