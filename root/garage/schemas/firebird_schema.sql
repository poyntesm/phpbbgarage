...
CREATE INDEX phpbb_garage_vehicles_date_created ON phpbb_garage_vehicles(filetime);;
CREATE INDEX phpbb_garage_vehicles_date_updated ON phpbb_garage_vehicles(post_msg_id);;
CREATE INDEX phpbb_garage_vehicles_user_id ON phpbb_garage_vehicles(topic_id);;
CREATE INDEX phpbb_garage_vehicles_views ON phpbb_garage_vehicles(poster_id);;
...
CREATE INDEX phpbb_garage_business_insurance ON phpbb_garage_business(group_id);;
CREATE INDEX phpbb_garage_business_garage ON phpbb_garage_business(group_id);;
CREATE INDEX phpbb_garage_business_retail ON phpbb_garage_business(group_id);;
CREATE INDEX phpbb_garage_business_product ON phpbb_garage_business(group_id);;
CREATE INDEX phpbb_garage_business_dynocentre ON phpbb_garage_business(group_id);;
...
CREATE INDEX phpbb_garage_categories_title ON phpbb_garage_categories(auth_option);;
...
ALTER TABLE phpbb_dynoruns_gallery ADD PRIMARY KEY (id);;

CREATE INDEX phpbb_dynoruns_gallery_vehicle_id ON phpbb_dynoruns_gallery(vehicle_id);;
CREATE INDEX phpbb_dynoruns_gallery_image_id ON phpbb_dynoruns_gallery(image_id);;

CREATE GENERATOR phpbb_dynoruns_gallery_gen;;
SET GENERATOR phpbb_dynoruns_gallery_gen TO 0;;

CREATE TRIGGER t_phpbb_dynoruns_gallery FOR phpbb_dynoruns_gallery
BEFORE INSERT
AS
BEGIN
	NEW.id = GEN_ID(phpbb_dynoruns_gallery_gen, 1);
END;;
...
CREATE INDEX phpbb_garage_guestbooks_author_id ON phpbb_garage_guestbooks(vehicle_id);;
CREATE INDEX phpbb_garage_guestbooks_post_date ON phpbb_garage_guestbooks(vehicle_id);;
...
CREATE INDEX phpbb_garage_modifications_user_id ON phpbb_garage_modifications(make_id);;
CREATE INDEX phpbb_garage_modifications_vehicle_id_2 ON phpbb_garage_modifications(vehicle_id, category_id);;
CREATE INDEX phpbb_garage_modifications_category_id ON phpbb_garage_modifications(make_id);;
CREATE INDEX phpbb_garage_modifications_vehicle_id ON phpbb_garage_modifications(make_id);;
CREATE INDEX phpbb_garage_modifications_date_created ON phpbb_garage_modifications(make_id);;
CREATE INDEX phpbb_garage_modifications_date_updated ON phpbb_garage_modifications(make_id);;
