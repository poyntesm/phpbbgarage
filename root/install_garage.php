...
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_search', 'garage_search.gif', 'en', 33, 130, 2)";
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_quartermile_table', 'garage_quartermile_table.gif', 'en', 33, 130, 2)";
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_lap_table', 'garage_lap_table.gif', 'en', 33, 130, 2)";
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_dynorun_table', 'garage_dynorun_table.gif', 'en', 33, 130, 2)";
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_garage_review', 'garage_garage_review.gif', 'en', 33, 130, 2)";
$required_sql[] = "INSERT INTO " . $table_prefix . "styles_imageset_data (image_name, image_filename, image_lang, image_height, image_width, imageset_id) VALUES ('garage_shop_review', 'garage_shop_review.gif', 'en', 33, 130, 2)";
...
switch( $mode )
{
	...
	case 'step3':
		...
		{
			$db->sql_query($makes_models_sql[$i]);
		}
