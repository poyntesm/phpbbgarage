...
$required_sql = array();
$required_sql[] = "CREATE TABLE " . $table_prefix . "garage (
...
$required_sql[] = "CREATE TABLE " . $table_prefix . "garage_gallery (
		`id` int(10) unsigned NOT NULL auto_increment,
...
$required_sql[] = "CREATE TABLE " . $table_prefix . "garage_insurance (
...
$required_sql[] = "CREATE TABLE " . $table_prefix . "garage_mods (
		`id` int(10) unsigned NOT NULL auto_increment,
		`garage_id` int(10) unsigned NOT NULL default '0',
		`user_id` int(10) NOT NULL default '0',
...
$required_sql[] = "UPDATE " . $table_prefix . "styles_imageset SET garage_rollingroad_table = '{LANG}/garage_rollingroad_table.gif*33*130'";
...
$required_sql[] = "UPDATE " . $table_prefix . "styles_imageset SET garage_add_rollingroad = '{LANG}/garage_add_rollingroad.gif*33*130'";
