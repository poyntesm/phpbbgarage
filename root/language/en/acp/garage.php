...
$lang = array_merge($lang, array(
	...
	'RATING_ALWAYS_UPDATEABLE_EXPLAIN' => 'If ratings not permanent this allows you to set if a rating can be changed at anytime, or only if vehicle has been updated since last rating.',
	...
	'ENABLE_QUARTERMILE_MENU' => 'Enable Quartermile Review Menu',
	...
	'YEAR_RANGE_END_EXPLAIN' => 'Amount of years offset from the current year for the latest year you want to appear as a selection for a new vehicle. If set to a positive integer the amount will be added to the current year, if set to a negative integer the amount will be subtracted from the current year. ',
