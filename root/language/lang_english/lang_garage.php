...
$lang['Garage_Permissions_Explain'] = '<b><u>Permissions & Quotas Guide</u></b> : Check box for access, uncheck to remove access. </br><b>\'DENY\'</b> will override any other permission. </br><b>\'BROWSE\'</b> dictates whether a user will be able to view the garage. </br><b>\'INTERACT\'</b> dictates whether the user will be able to vote and leave comments in the Garage. </br><b>\'ADD\'</b> dictates whether the user will be able to add, edit & delete vehicles and modifications to the Garage. </br><b>\'UPLOAD\'</b> dictates whether the user will be able to upload images in the Garage. The default quota will apply to all users unless group membership grants them a higher value.<br /><br /><b>NOTE:</b> Regardless of permission settings for Guests below they will not be allowed to add a new vehicle to the Garage and hence images as well.<br /><b>NOTE:</b> When a user is a member of mutliple groups, each granted quotas the highest quota will apply.';
...
$lang['Make_Exists'] = 'Make Already Exists';
...
//Added For v2
// Custom fields
$lang['FIELD_INT'] = 'Numbers';
$lang['FIELD_STRING'] = 'Single Textfield';
$lang['FIELD_TEXT'] = 'Textarea';
$lang['FIELD_BOOL'] = 'Boolean (Yes/No)';
$lang['FIELD_DROPDOWN'] = 'Dropdown Box';
$lang['FIELD_DATE'] = 'Date';
$lang['NO_FIELD_TYPE'] = 'No Field type specified';
$lang['FIRST_OPTION'] = 'First Option';
$lang['SECOND_OPTION'] = 'Second Option';
$lang['EMPTY_FIELD_IDENT'] = 'Empty field name';
$lang['INVALID_CHARS_FIELD_IDENT'] = 'Field name can only contain lowercase a-z and _';
$lang['EMPTY_USER_FIELD_NAME'] = 'Empty Field Name presented to the user';
$lang['PROFILE_BASIC_OPTIONS'] = 'Basic Options';
$lang['PROFILE_TYPE_OPTIONS'] = 'Type specific options';
$lang['PROFILE_LANG_OPTIONS'] = 'Language specific options';
$lang['STEP_1_TITLE_CREATE'] = 'Add Custom Field';
$lang['STEP_1_TITLE_EDIT'] = 'Edit Custom Field';
$lang['STEP_1_EXPLAIN_CREATE'] = 'Here you can enter the first basic parameters of your new custom field. These informations are needed for the second step where you are able to set remaining options and where you are able to preview and tweak your custom field further.';
$lang['STEP_1_EXPLAIN_EDIT'] = 'Here you can change the basic parameters of your custom field. The relevant options are re-calculated within the second step, where you are able to preview and test the changed settings.';
$lang['STEP_2_TITLE_CREATE'] = 'Type specific options';
$lang['STEP_2_TITLE_EDIT'] = 'Type specific options';
$lang['STEP_2_EXPLAIN_CREATE'] = 'Here you are able to define some common options. Further you are able to preview the field you generated, as the user will see it. Play around with it until you are satisfied as how the field behaves.';
$lang['STEP_2_EXPLAIN_EDIT'] = 'Here you are able to change some common options. Further you are able to preview the changed field, as the user will see it. Play around with it until you are satisfied as how the field behaves.<br /><b>Please note that changes to custom fields will not affect existing custom fields entered by your users.</b>';
$lang['STEP_3_TITLE_CREATE'] = 'Remaining Language Definitions';
$lang['STEP_3_TITLE_EDIT'] = 'Language Definitions';
$lang['STEP_3_EXPLAIN_CREATE'] = 'Since you have more than one board language installed, you have to fill out the remaining language items too. The profile field will work with the default language enabled, you are able to fill out the remaining language items later too.';
$lang['STEP_3_EXPLAIN_EDIT'] = 'Since you have more than one board language installed, you now can change or add the remaining language items too. The profile field will work with the default language enabled.';
$lang['ROWS'] = 'Rows';
$lang['COLUMNS'] = 'Columns';
$lang['UPDATE_PREVIEW'] = 'Update Preview';
$lang['PREVIEW_PROFILE_FIELD'] = 'Preview Custom Field';
$lang['EVERYTHING_OK'] = 'Everything OK';
$lang['STRING_DEFAULT_VALUE_EXPLAIN'] = 'Enter a default phrase to be displayed, a default value. Leave empty if you want to show it empty at the first place.';
$lang['TEXT_DEFAULT_VALUE_EXPLAIN'] = 'Enter a default text to be displayed, a default value. Leave empty if you want to show it empty at the first place.';
$lang['BOOL_ENTRIES_EXPLAIN'] = 'Enter your options now';
$lang['DROPDOWN_ENTRIES_EXPLAIN'] = 'Enter your options now, every option in one line';
$lang['REQUIRED_FIELD'] = 'Required Field';
$lang['REQUIRED_FIELD_EXPLAIN'] = 'Force custp, field to be filled out or specified by user';
$lang['DISPLAY_AT_REGISTRATION'] = 'Display at creation screen';
$lang['HIDE_PROFILE_FIELD'] = 'Hide Custom Field';
$lang['HIDE_PROFILE_FIELD_EXPLAIN'] = 'Only Administrators and Moderators are able to see/fill out this custom field';
$lang['EXCLUDE_FROM_VIEW'] = 'Do not display custom field';
$lang['EXCLUDE_FROM_VIEW_EXPLAIN'] = 'The profile field will not be shown on viewtopic/viewprofile/memberlist/etc.';
$lang['ADDED_PROFILE_FIELD'] = 'Successfully added custom field';
$lang['CREATE_NEW_FIELD'] = 'Create New Field';
$lang['REMOVED_PROFILE_FIELD'] = 'Successfully removed custom field.';
$lang['CONFIRM_DELETE_PROFILE_FIELD'] = 'Are you sure you want to delete this custom field?';
$lang['PROFILE_FIELD_ACTIVATED'] = 'Custom field successfully activated';
$lang['PROFILE_FIELD_DEACTIVATED'] = 'Custom field successfully deactivated';
$lang['CHANGED_PROFILE_FIELD'] = 'Successfully changed custom field';
$lang['LOG_CREATE_PROFILE_FIELD'] = '<b>Custom field added</b><br />&#187; %s';
$lang['LOG_EDIT_PROFILE_FIELD'] = '<b>Custom field changed</b><br />&#187; %s';
$lang['LOG_ACTIVATE_PROFILE_FIELD'] = '<b>Custom field activated</b><br />&#187; %s';
$lang['LOG_DEACTIVATE_PROFILE_FIELD'] = '<b>Custom field deactivated</b><br />&#187; %s';
$lang['LOG_REMOVED_PROFILE_FIELD'] = '<b>Custom field removed</b><br />&#187; %s';
$lang['CHARS_ANY'] = 'Any character';
$lang['NUMBERS_ONLY'] = 'Only numbers (0-9)';
$lang['ALPHA_ONLY'] = 'Alphanumeric only';
$lang['ALPHA_SPACERS'] = 'Alphanumeric and spacers';
$lang['FIELD_TYPE'] = 'Field Type';
$lang['FIELD_TYPE_EXPLAIN'] = 'You are not able to change the field type later.';
$lang['FIELD_IDENT'] = 'Field Name';
$lang['FIELD_IDENT_EXPLAIN'] = 'The Field Name is a name for you to identify the custom field, it is not displayed to the user.';
$lang['LANG_SPECIFIC_OPTIONS'] = 'Language specific options [<b>%s</b>]';
$lang['USER_FIELD_NAME'] = 'Field Name presented to the user';
$lang['FIELD_DESCRIPTION'] = 'Field Description';
$lang['FIELD_DESCRIPTION_EXPLAIN'] = 'The Explanation for this field presented to the user';
$lang['CP_LANG_NAME'] = 'Field Name presented to the user';
$lang['CP_LANG_EXPLAIN'] = 'Field Description';
$lang['CP_LANG_EXPLAIN_EXPLAIN'] = 'The Explanation for this field presented to the user';
$lang['CP_LANG_DEFAULT_VALUE'] = 'Default Value';
$lang['CP_LANG_OPTIONS'] = 'Options';
$lang['FIELD_LENGTH'] = 'Length of input box';
$lang['MIN_FIELD_CHARS'] = 'Minimum number of characters';
$lang['MAX_FIELD_CHARS'] = 'Maximum number of characters';
$lang['MIN_FIELD_NUMBER'] = 'Lowest allowed number';
$lang['MAX_FIELD_NUMBER'] = 'Highest allowed number';
$lang['DEFAULT_VALUE'] = 'Default Value';
$lang['FIELD_VALIDATION'] = 'Field Validation';
$lang['ENTRIES'] = 'Entries';
$lang['BOOL_TYPE_EXPLAIN'] = 'Define the Type, either a checkbox or radio buttons';
$lang['RADIO_BUTTONS'] = 'Radio Buttons';
$lang['CHECKBOX'] = 'Checkbox';
$lang['NO_VALUE_OPTION'] = 'Option equal to non entered value';
$lang['NO_VALUE_OPTION_EXPLAIN'] = 'Value for a non-entry. If the field is required, the user gets an error if he choose the option selected here';
$lang['ALWAYS_TODAY'] = 'Always the current date';
$lang['DEFAULT_ISO_LANGUAGE'] = 'Default Language [%s]';
$lang['ISO_LANGUAGE'] = 'Language [%s]';
$lang['NO_FIELD_ID'] = 'No field id specified';
$lang['FIELD_NOT_FOUND'] = 'Custom field not found';
$lang['NO_FIELD_ENTRIES'] = 'No Entries defined';
...
$lang['YES'] = 'Yes';
$lang['NO'] = 'No';
$lang['Garage_DB_Backup'] = 'Garage DB Backup';
$lang['Start_Backup'] = 'Start Backup';
$lang['Garage_DB_Restore'] = 'Garage DB Restore'; 
$lang['Pending_Notify_Text'] = '<b>****This message is automatically generated by the site.****</b><br /><br />The Garage Has A New Pending Item<br />Click %s To View Pending Items';
$lang['Local'] = 'Local';
$lang['Remote'] = 'Remote';
