		<td width="72%" valign="top" >
			...
			<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
				...
				<tr>
					<td class="catBottom" align="center" height="28" colspan="2"><input type="hidden" value="{CID}" name="CID" /><input type="hidden" value="{BUSINESS_ID}" name="id" /><input type="hidden" value="{MODE_REDIRECT}" name="mode_redir" /><input name="submit" type="submit" value="{L_ADD_NEW_BUSINESS}" class="liteoption" /></td>
				</tr>
			</table>
			</form>
		</td>
