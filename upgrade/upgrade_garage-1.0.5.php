...
$page_title = 'Upgrading To phpBB Garage Version 1.0.6';
include($phpbb_root_path . 'includes/page_header.'.$phpEx);

echo '<table width="100%" cellspacing="1" cellpadding="2" border="0" class="forumline">';
echo '<tr><th>Upgrading To phpBB Garage Version 1.0.6</th></tr><tr><td class="row1" ><span class="genmed"><ul type="circle">';

$sql = array();

$sql[] = "UPDATE " . $table_prefix . "garage_config SET config_value = '1.0.6' WHERE config_name = 'version'";
